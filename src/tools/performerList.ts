...
/**
 * List SeatGeek performers with simple filters (q, id, type).
 * Returns structured models or raw JSON with format='json'.
 */
export const listPerformersTool = {
  name: 'list_performers',
  description: 'Search for performers and artists by name. Use this tool to find information about artists, bands, sports teams, and other performers. Use q for free-text searches. Returns performer details including images, URLs, and taxonomy information.',
